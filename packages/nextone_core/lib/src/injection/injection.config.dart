...
import '../services/implementations/auth/auth_service.dart' as _i60;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i315.IArtistRepository>(() =>
        _i892.ArtistRepository(supabaseClient: gh<_i454.SupabaseClient>()));
    gh.lazySingleton<_i668.IAuthService>(
        () => _i60.AuthService(supabaseClient: gh<_i454.SupabaseClient>()));
    gh.lazySingleton<_i315.IUserRepository>(
        () => _i835.UserRepository(supabaseClient: gh<_i454.SupabaseClient>()));
